			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="admin/users/display_user_list"><i class="icon-user"></i><span class="hidden-tablet">Users</span></a></li>
                       <li>
							<a class="dropmenu" href="#"><i class="icon-share"></i><span class="hidden-tablet">Sharing Rules</span><span class="label label-important"></span></a>
							<ul>
             <li><a class="submenu" href="admin/cms/display_cms"><i class="icon-file-alt"></i><span class="hidden-tablet">List of Rules</span></a></li>
								
             <li><a class="submenu" href="admin/cms/add_cms_form"><i class="icon-file-alt"></i><span class="hidden-tablet">Add New</span></a></li>
							</ul>	
						</li>
                        
                        
                        
     <li><a href="admin/Hoopy_types/display_Hoopy_types"><i class="icon-home"></i><span class="hidden-tablet">Hoopy Types</span></a></li>
      
          
          
          
          <li>
	    <a class="dropmenu" href="#"><i class="icon-dashboard"></i><span class="hidden-tablet">Distance Mgnt</span><span class="label label-important"></span></a>
			 <ul>
             <li><a class="submenu" href="admin/distance/display_distance"><i class="icon-file-alt"></i><span class="hidden-tablet">Distance List</span></a></li>
             <li><a class="submenu" href="admin/distance/add_new_distance_form"><i class="icon-file-alt"></i><span class="hidden-tablet">Add New</span></a></li>
			</ul>	
		</li>
