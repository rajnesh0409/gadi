...
<script type="text/javascript" src="js/jquery.MultiFile.js"> </script>
	...
	<!-- start: Content -->
			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="admin/become_partner/insert_partner" id="add_amenitys" method="post" enctype="multipart/form-data">
							<fieldset>
			...
			<input type="checkbox" name="services[]" value="<?php echo $row->name;?>"><?php echo $row->name;?>
								  </label>
								 <?php }?>
								</div>
							  </div>
                           ...
                           <hr><h3 style="padding-left: 46px;padding-bottom: 8px;">Choose Brand Logos</h3></hr>
							  <div class="control-group">
							  <label class="control-label" for="fileInput">Images <span class="mandatory">*</span></label>
							  <div class="controls">
								<input class="input-file uniform_on required multi" maxlength="5" name="images[]" id="images" type="file">
							  </div>
							</div>
