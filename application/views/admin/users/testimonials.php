			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="admin/users/insert_testm" id="add_amenity" method="post" enctype="multipart/form-data">
							<fieldset>
                              ...
                              <div class="control-group">
							   ...
							   <div class="control-group">
								<label class="control-label" for="veh_name">Vehicle Name<span class="mandatory">*</span></label>
								<div class="controls">
								  <input type="text" required class="required" id="veh_name" name="veh_name" rows="3">
								</div>
							  </div>
							  ...
							  <div class="controls">
								<textarea class="required" required id="description" name="description" rows="3"></textarea>
							  </div>
							</div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input class="input-file uniform_on required" required name="image" id="image" type="file">
							  </div>
