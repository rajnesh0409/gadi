    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4" style="padding-bottom: 45px;">
            ...
            <div class="account-wall">
                ...
                <form class="form-signin" action="<?php echo SHORTURL; ?>forgetlink" method="post" enctype="multipart/form-data">
               
                <input class="form-control" type="hidden" name="userId" value="<?php echo $userId; ?>">
			    <input class="form-control" type="hidden" name="verifyCode" value="<?php echo $verifyCode; ?>">
				
				<div class="form-group labelholder">
				<input class="form-control" type="password" name="password" placeholder="Enter new password" required title="Enter new password">
			    </div>
				
				<div class="form-group labelholder">
				
				<input class="form-control" type="password" name="repassword" placeholder="Retype your password" required title="Retype your password">
