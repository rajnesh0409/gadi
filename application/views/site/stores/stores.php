	 ...
	 <?php  $this->load->view('site/vehicles/midsection.php');?>
		 ...
		 <!-- <div class="col-md-2">
		   ...
		   <div class="col-md-3">
            ...
            <option selected disabled value="">Select distance</option>
	...
	var checkedValues = $('input:checkbox:checked').map(function() {
		...
		{		
			...
			else
			{
			    ...
			    mnseoshdfhftrt = mnseoshdfhftrt+','+wow['4'];
			}	
		...
		localStorage.setItem("mnseoshdfhftrt", mnseoshdfhftrt);
		...
		localStorage.setItem("storename", storename);
			...
			if($('.stores').is(':checked')) { 
			       ...
			       var mnseoshdfhftrt = localStorage.getItem("mnseoshdfhftrt").trim();
				   
				   
				   $.ajax({
					url: FULLURL+'calls/storeservice',
					data: {
					mnseoshdfhftrt: mnseoshdfhftrt,
					},
					type: 'POST',
					success: function( data ) {
						data = data.trim();
