  ...
  <div class="row text-center">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="single_icon  text-center"> 
						<a href="#" class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
							 <img src="images/car-wheel.png" class="servi">
						</span> 
						</a>  
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a href="#" class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
						 <img src="images/speedometer.png" class="servi">
						</span>
						</a>						
						<div class="icon_details">
							<h2>Speedometer Repair</h2>
							<p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled..</p>
						</div>
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						...
						<span class="hb inv hb-md hvr-shrink wow fadeInRightBig">
							 <img src="images/working-tools.png" class="servi">
						</span>  
						</a>
						<div class="icon_details">
							<h2>Inspection</h2>
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a href="#" class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInRightBig">
							 <img src="images/space.png" class="servi">
						</span>  
						</a>
						<div class="icon_details">
							<h2>Upgrades</h2>
