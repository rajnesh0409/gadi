 ...
 <div class="container">
   ...
   <div class="row text-center">
			   ...
			   <div class="col-lg-6 wow fadeIn">
				<div class="introduce_heading wow fadeInLeft">
							<h3>Let's introduce <span style="color:rgba(242, 111, 33, 0.9)">Hoopy</span></h3>
                            ...
                            So sit back, relax and book your vehicle service from our App or Website and get offerings from handpicked highly rated service centers.</p>
						</div>
                </div> 
                
				<div class="col-lg-6 wow lightSpeedIn">
				<img src="assets/img/car.png" alt="hoopy" style="width: 86%;">
  ...
  <div class="row text-center">
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon  text-center"> 
						...
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
							 <img src="images/verified service centers.png" class="servi">
						</span> 
						</a>  
						<div class="icon_details">
							<h2>Verified service centers</h2>
							<p>Hoopy strives to provide good quality vehicle services through our trusted service centres. We verify each of the listed service centres in order to ensure integrity, transparency and authentic service for your vehicle.
                             </p>
						</div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a  class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
						 <img src="images/confirm time slot.png" class="servi">
						</span>
						</a>						
						<div class="icon_details">
							<h2>Confirmed slots</h2>
							<p>Never miss a due service, with Hoopy you can always get a confirmed slot in the garage of your choice and get your vehicle serviced on time.
                            </p>
						</div>
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInRightBig">
							 <img src="images/payment.png" class="servi">
						</span>  
						</a>
						<div class="icon_details">
							<h2>Easy payment</h2>
							<p>At the time of your vehicle delivery, the payment can be made online or via cash/card as per your convenience. </p>
						</div>
  ...
  <div class="row text-center">
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon  text-center"> 
						<a  class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
							 <img src="images/transit insurance.png" class="servi">
						</span> 
						</a>  
						<div class="icon_details">
							<h2>Transit insurance</h2>
							<p>Hoopy aims at providing you a complete peace of mind when you hand over your vehicle to us. Your vehicle is our responsibility from the time it is picked up till the time it’s dropped. Each customer’s vehicle is fully insured with our transit insurance policy.
                           </p>
						</div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a  class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInLeftBig">
						 <img src="images/alternate.png" class="servi">
						</span>
						</a>						
						<div class="icon_details">
							<h2>Alternate vehicle</h2>
							<p>Customer convenience is our utmost priority. Giving your vehicle away for service should not affect your daily schedule. To save you from this trouble, hoopy provides an option of an alternate mode of transport to make your commute easy.
                            </p>
						</div>
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="single_icon text-center">
						<a  class="hb-md-margin">
						<span class="hb inv hb-md hvr-shrink wow fadeInRightBig">
							 <img src="images/transparency.png" class="servi">
						</span>  
						</a>
						<div class="icon_details">
							<h2>Transparency</h2>
							<p>Our aim is to standardize and organize the vehicle service industry. To achieve this, Hoopy provides verified quotes, recommended service after vehicle inspection, itemized bill and no hidden charges.</p>
						</div>
...
/* 5.2 - Default hover colors//  hexa hover bawe
-------------------------------------------------*/
