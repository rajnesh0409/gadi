...
//		$this->load->database();
	...
	public function gedetails($table='',$condition='',$sortArr=''){
	...
	public function bookdetails($table='',$where=''){
	...
	public function gedmodelre($table='',$condition='',$sortArr=''){
	...
	public function gedbrandre($table='',$condition='',$sortArr=''){
	...
	public function lastinsert($table='',$data=''){
	...
	public function commonlastinsert($table='',$mode='',$excludeArr='',$dataArr='',$condition='') {
		$inputArr = array();
		foreach ($this->input->post() as $key => $val){
			if (!in_array($key, $excludeArr)){
				$inputArr[$key] = $val;
