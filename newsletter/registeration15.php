...
<tr>
<td colspan=\"2\">
<h3 style=\"padding: 10px 15px; margin: 0px; color: #0d487a;\">'.$name.' Contact for you</h3>
<p style=\"padding: 0px 15px 10px 15px; font-size: 12px; margin: 0px;\">Name: '.$name.'</p>
<p style=\"padding: 0px 15px 10px 15px; font-size: 12px; margin: 0px;\">Email: '.$email.'</p>
<p style=\"padding: 0px 15px 10px 15px; font-size: 12px; margin: 0px;\">Phone no: '.$subject.'</p>
<p style=\"padding: 0px 15px 10px 15px; font-size: 12px; margin: 0px;\">Message: '.$message.'</p>
</td>
</tr>
<tr>
